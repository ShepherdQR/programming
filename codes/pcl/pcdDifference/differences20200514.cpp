...
//  * LastEditTime: 2020-06-12 23:27:10
...
/*
    tank  ori002 vs scan004: 
    Template ori point number is: 102104
    Target ori point number is: 19720
    0.0177103


    tank ori002 vs  scan004 + perlin:
    Template ori point number is: 102104
    Target ori point number is: 19720
    0.0177089
...
string dataFolder = "/home/jellyfish/programming/codes/pcl/pcdDifference/";
string fileName[2]= {"vox-Tank1-T99A002-20200525-06:52:14.pcd",  "vox-Tank1-T99A004-20200525-03:23:48.pcd"   };





bool voxSwitch(false);
    float voxSize = 0.007;
...
int main( int argc, char** argv ){
    ...
    viewer1.setPointCloudRenderingProperties( pcl::visualization::RenderingProperties::PCL_VISUALIZER_POINT_SIZE, 5, "cloud_1");//2
    viewer1.setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_COLOR, 1,0,0, "cloud_1");
    ...
    viewer1.setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_COLOR, 0,1,0, "cloud_2");
