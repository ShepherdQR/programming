...
//  * LastEditTime: 2020-06-13 00:04:17
...
int main(int argc, char **argv){
    ...
    */
    ...
    viewer1.setPointCloudRenderingProperties( pcl::visualization::RenderingProperties::PCL_VISUALIZER_POINT_SIZE, 3, "cloudOri_zqr" );
    ...
    outfile << "Compute normals time : " << timeTemp << "ms." << endl;
        ...
        //drawArrows(viewer1, cloudOri,cloudNormal, 100, 5, 0.03);// every n number; angle; lengthSize   for bunny 
        drawArrows(viewer1, cloudOri,cloudNormal, 100, 5, 0.3);
